...
## Problem
Search and social previews are degraded: page title, meta description, Open Graph tags are missing or outside recommended lengths.

## Evidence (from the live site)
> Measured on the homepage: title 9 chars (15-60 recommended); description 0 chars (70-160 recommended); og:title missing, og:image missing.

## Current state
notes: page title; meta description; Open Graph tags
